sap.ui.require([
  ...
  var sViewName = "com.mindset.wm.bayperformance.view.MainView";
      ...
      assertions: {
          ...
          iShouldSeeTheTitle: function () {
            return this.waitFor({
              ...
              properties: {
                text: "com.mindset.wm.bayperformance"
              },
              success: function() {
                Opa5.assert.ok(true, "The page shows the correct title");
              },
              errorMessage: "App does not show the expected title com.mindset.wm.bayperformance"
            });
        }
      }
